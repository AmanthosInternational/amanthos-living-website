...
(function () {
  ...
  var GA4_MEASUREMENT_ID = 'G-8LPLG0BPJ6';
  ...
  function pixelLaden() {
    ...
    try {
      ...
      // 08.09.2026 nahm fbevents.js den Widerruf aus der Warteschlange, hielt
      // danach an und liess `init`, `PageView` und das nachgeschobene `grant`
      // ungelesen liegen. Kein Ereignis, kein Cookie, keine Meldung, obwohl
      // `fbq` geladen war. Ein Widerruf kommt nur noch ueber den Listener unten,
      // wenn jemand die Zustimmung spaeter zurueckzieht.
